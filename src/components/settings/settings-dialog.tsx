  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent
        ...
        // DialogContent supplies the canonical large Liquid Glass stack.
        // This component owns only geometry and internal layout.
        className="flex h-[600px] max-h-[85vh] w-[880px] max-w-[calc(100vw-2rem)] flex-row gap-0 overflow-hidden p-0 sm:max-w-[880px]"
      >
